...
public class ModEffect {
    ...
    public static final StatusEffect ARMOR_CRUSH = registerStatusEffect("armor_crush",
            new ArmorCrushEffect(StatusEffectCategory.HARMFUL,0x3b271e)
                    .addAttributeModifier(EntityAttributes.GENERIC_ARMOR_TOUGHNESS,
    ...
    public static void registerEffects() {
        TheWorldRift.LOGGER.info("Register Mod Effects for " + TheWorldRift.MOD_ID); }
}
