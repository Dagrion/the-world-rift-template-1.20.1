...
public class BloodstainedDualBlade extends SwordItem {
    public BloodstainedDualBlade(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
