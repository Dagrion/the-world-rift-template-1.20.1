...
public class BloodstainedKnife extends SwordItem {
    ...
    public BloodstainedKnife(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
