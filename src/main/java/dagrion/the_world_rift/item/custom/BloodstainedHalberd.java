...
public class BloodstainedHalberd extends AxeItem {
    ...
    public BloodstainedHalberd(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
