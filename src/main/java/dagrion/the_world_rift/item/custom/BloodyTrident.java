...
public class BloodyTrident extends Item implements Vanishable {
    ...
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;
        ...
        public BloodyTrident(Item.Settings settings) {
            super(settings);
                    ...
                    if (j <= 0 || playerEntity.isTouchingWaterOrRain()) {
                        if (!world.isClient) {
                            ...
                            if (j == 0) {
                                ...
                                tridentEntity.setVelocity(playerEntity, playerEntity.getPitch(), playerEntity.getYaw(), 0.0F, 5.0F + (float) j * 0.5F, 1.0F);
