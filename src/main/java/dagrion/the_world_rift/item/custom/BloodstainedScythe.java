...
public class BloodstainedScythe extends AxeItem {
    ...
    public BloodstainedScythe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
