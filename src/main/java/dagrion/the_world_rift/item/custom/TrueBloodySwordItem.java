...
public class TrueBloodySwordItem extends SwordItem {
    ...
    public TrueBloodySwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
